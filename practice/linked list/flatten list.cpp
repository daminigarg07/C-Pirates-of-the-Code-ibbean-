...
//Understand the structure: Each node in the main linked list contains a pointer to the next node and a pointer to the head of a sub-linked list (bottom pointer). Each sub-linked list is sorted.
//
